 ...
 * @example
  ...
  ```
 */
declare const JitsiMeeting: ({ domain, roomName, configOverwrite, interfaceConfigOverwrite, jwt, invitees, devices, userInfo, release, spinner: Spinner, onApiReady, onReadyToClose, getIFrameRef }: IJitsiMeetingProps) => ReactElement;
